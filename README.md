# OpenSSL  Latest version for iOS and oSX
# Full bitcode support

````
* Full Bit code support. 
* No More Non-modular header error.
* Ready for App Submission to Apple Store.
````
...
```
github "mjhatamy/OpenSSL"
```

### Authors

[Majid Hatami](https://twitter.com/mjhatamy)
...
Add `pod 'OpenSSL'` inside the podfile.
Save the file.
